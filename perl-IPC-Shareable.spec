...
Source0  : https://cpan.metacpan.org/authors/id/S/ST/STEVEB/IPC-Shareable-1.06.tar.gz
...
%prep
%setup -q -n IPC-Shareable-1.06
cd %{_builddir}
tar xf %{_sourcedir}/libipc-shareable-perl_0.61-2.debian.tar.xz
cd %{_builddir}/IPC-Shareable-1.06
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/IPC-Shareable-1.06/deblicense/
...
cp %{_builddir}/IPC-Shareable-1.06/COPYING %{buildroot}/usr/share/package-licenses/perl-IPC-Shareable/075d599585584bb0e4b526f5c40cb6b17e0da35a
